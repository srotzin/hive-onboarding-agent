...
const DID='did:hive:hiveforce-onboarding';const ID={name:'HiveForce-Onboarding',purpose:'Guided agent onboarding — tutorial flows, credential provisioning, integration setup, first-execution hand-holding',capabilities:["tutorial_flows","credential_provisioning","integration_setup","guided_execution"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-onboarding-agent',purpose:ID.purpose})}
